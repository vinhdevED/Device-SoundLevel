...
const IOT_DEVICE_IP = '192.168.1.101'; // Địa chỉ broadcast để gửi gói tin tới tất cả thiết bị trong mạng cục bộ
...
app.listen(port, () => {
    console.log(`HTTP server running at http://192.168.1.100:${port}`);
});
